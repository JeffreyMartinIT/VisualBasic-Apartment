...
#Region "Subs"
    ...
    ''' <summary>
    ''' Items done when page is loaded
    ''' </summary>
    ...
    ''' <summary>
    ''' When delete button is clicked deactivate the lease number and associated residents.
    ''' </summary>
    ...
    Protected Sub DeleteButton_Click(sender As Object, e As EventArgs) Handles DeleteButton.Click
        ...
        'Call the method that will deactivate the lease and residents.
    ...
    ''' <summary>
    ''' Event handler to refresh the current contracts page.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Protected Sub CancelButton_Click(sender As Object, e As EventArgs) Handles CancelButton.Click
        'Reset the current contracts page.
        Response.Redirect("CurrentContracts.aspx")
    End Sub
